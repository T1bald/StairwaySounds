...
//			}
            ...
            listItem += "<div class='col-md-2 col-lg-2 track-details'><button onclick='location.href=\"track?id=" + media.id + "\"' type='button' class='btn btn-default'>Details</button></div>";
            listItem += "</li>";
